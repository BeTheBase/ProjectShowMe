...
public enum EVENT { humanDetectEvent, blendEvent, checkPointEvent, humanCollected, recipeManagerSaved, recipeManagerLoad, managerLoadEvent, gameUpdateEvent, reloadGame, initializeGame, saveGame, selectGame }; // ... Other events
/// <summary>
